...
$("#all").click(function(){
    ...
    $.ajax({
        url: 'cate_master/admin_php/all.php',
        type: 'get',
        dataType: 'JSON',
...
$(document).on('click', '.btn_save', function(event) 
{
    ...
    $.post( 
        "cate_master/admin_php/cate_update.php", 
        obj,
        function( data ) {
            console.log(data);
    });
...
$.ajax({
       type: "POST",
       url: "cate_master/admin_php/add.php",
...
function cate_delete(id){
    ...
    if(con){
        ...
        $.post( 
        "cate_master/admin_php/delete.php", 
        {id:id},
        function( data ) {
          if (data=='1'){
...
$("#btn_member").click(function(){
	$.get('admin_php/cate_members.php',
	function(res){
