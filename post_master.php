...
<?php
    ...
    function comment_show($id){
        ...
        $query = "select member_profile.first_name,thread_comments.post_id,thread_comments.post_thread_id,thread_comments.comments,thread_comments.thread_created_date from member_profile INNER JOIN thread_comments
                                                ON thread_comments.member_id = member_profile.member_id WHERE thread_comments.post_thread_id = ".$id." AND thread_comments.post_id = ".$_SESSION['post_id']." ORDER BY thread_comments.thread_comments_id desc;";
...
$_SESSION['post_id']=$_GET['id'];
    $query = "select * from post_master where post_master_id =  ".$_SESSION['post_id'].";";
	 ...
	 if (empty($thread)){
		 ...
		 save_thread($thread);
                 ...
                 ?>
                   <script>
                        /* $('body,html').animate({
                           scrollTop: $("#showErrors").offset().top
                          }, 500 );
                   </script>
                 <?php
	 }
...
if(@$kError == 1){
    ?>
      <script>
          $("#showErrors2").show(1000);
          $('body,html').animate({
                 scrollTop: $("#showErrors2").offset().top
            }, 500 );
      </script>
    <?php
}
...
?>
 <?php function display_data($posts){
          $db = new mysqli('localhost','londoners','London123!','Londoners');
$_SESSION['post_id']=$_GET['id'];
          $query_thread = "select * from post_threads INNER JOIN member_profile on post_threads.member_id = member_profile.member_id where post_master_id = ".$_SESSION['post_id'].";";
                                                                                ...
                                                                                <div class="comment-meta">
                                                                                        ...
                                                                                        <h5 class="author">
                                                                                                <cite class="fn">
                                                                                                 ...
                                                                                                 {
                                                                                                         if(count($comments) == 1){
                                                                                                                echo "(".count($comments).")Reply";
                                                                                                         }else{
                                                                                                         echo "(".count($comments).")Replies";
                                                                                                        }
                                                                                                 }
                                                                                                 else{
                                                                                                         echo "(0)Replies";} 
...
<!-- The form//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
                                                        ...
                                                        <div id="respond">
                                                                ...
                                                                <div id = "showErrors" class="container alert alert-danger" style = "display:none;margin-top:20px;">
                                                                      <strong> ERROR!</strong> Comment Cannot be Empty!                                                              </div>
                                                                </div>

                                                                <div id = "showErrors2" class="container alert alert-danger" style = "display:none;margin-top:20px;">
                                                                      <strong> ERROR!</strong> Please Signin or Signup to Continue!    
