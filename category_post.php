...
{      
	?>
	 ...
	 <label for="heading">Heading</label>  
		<input type="text" size="200"  id ="txtheading" name="txtheading"  class ="form-control"  value= "<?php echo  $heading ?>"></input>
		<br>
				 <br>  

				 <label for="txtContents">Content</label>
		<textarea id="txtContents" name="txtContents" rows="7" cols="250" maxlength="65530"  width ="100%" class ="form-control" ><?php echo  $contents ?></textarea>
		
				 		
				 
				 <br>
				 
				 <input type="submit" id ="btn_post_save" name ="btn_post_save" class="btn btn-default"  onclick ="currentPage(this,'post_all.php');"  value="Save" />
